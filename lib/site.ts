export const siteConfig = {
  ...
  description: "Portfólio de Murilo Alves (Murilo Dev) — Desenvolvedor Web especializado em Backend, PHP, React, Node, Docker e Automações. Disponível para projetos.",
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://itsmuriloa.com",
  email: "itsmurilo.dev@gmail.com",
  whatsapp: "https://wa.me/5551994028000",
  github: "https://github.com/itsmurilodev",
  linkedin: "https://www.linkedin.com/in/itsmurilodev/",
