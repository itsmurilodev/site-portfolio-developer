...
const statusLabel = aboutProfile.status === "OPEN" ? "disponível" : "em progresso";
                  ...
                  <div className="relative h-52 w-full overflow-hidden rounded-md border border-terminal-orange/45 bg-bg-deep shadow-[0_0_42px_rgba(255,92,36,0.16)] sm:h-64 lg:h-64 xl:h-72">
                    {aboutProfile.photoSrc ? (
                      ...
                      <div
                        ...
                        role="img"
                      >
                        <span className="font-mono text-5xl font-bold text-terminal-orange-soft">
                          MA
                        </span>
                      </div>
                    )}
          ...
          <dl className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:col-span-12">
            {aboutStats.map((stat) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="group relative overflow-hidden rounded-md border border-white/[0.08] bg-panel-bg/90 p-3.5 shadow-[0_14px_42px_rgba(0,0,0,0.35)] transition duration-300 hover:border-terminal-orange/35 hover:bg-panel-light/80"
                >
