    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-8 flex flex-col">
          <TerminalWindow title="whoami.sh" className="flex-1 min-h-[350px]">
            ...
            <div className="flex items-center gap-2 mb-3 select-none text-zinc-500">
              <span className="text-purple-400 font-bold">guest@murilo-os:~$</span>
            ...
            <div className="pl-4 border-l border-zinc-900 flex flex-col gap-4 mb-6">
              <div className="flex items-start gap-2.5">
                <User className="w-4 h-4 text-cyan-400 mt-1 flex-shrink-0 select-none" />
            ...
            <div className="flex items-center gap-2 mb-3 select-none text-zinc-500">
              <span className="text-purple-400 font-bold">guest@murilo-os:~$</span>
              <span className="text-zinc-200">cat mission.txt</span>
            </div>

            {/* Output 2 */}
            <div className="pl-4 border-l border-zinc-900 flex flex-col gap-2">
              <div className="flex items-start gap-2.5">
                <Target className="w-4.5 h-4.5 text-purple-400 mt-0.5 flex-shrink-0 select-none" />
                <h3 className="text-sm font-semibold text-zinc-100 font-sans">Missão:</h3>
              </div>
              <p className="pl-7 text-sm font-mono text-cyan-400 leading-relaxed max-w-2xl">
        ...
        <div className="lg:col-span-4 flex flex-col">
          <div className="flex-1 rounded-xl border border-zinc-800/80 bg-zinc-950/45 p-6 backdrop-blur-md shadow-lg flex flex-col justify-between relative overflow-hidden group">
            
            {/* Grid background details */}
            <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.005)_1px,transparent_1px)] bg-[size:20px] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4 font-mono text-xs">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-cyan-400 leading-relaxed font-semibold">
